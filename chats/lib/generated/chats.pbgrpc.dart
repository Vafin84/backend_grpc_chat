...
class ChatsRpcClient extends $grpc.Client {
  ...
  static final _$sendMessage =
      $grpc.ClientMethod<$0.MessageDto, $0.ResponseDto>(
          ...
          ($core.List<$core.int> value) => $0.ResponseDto.fromBuffer(value));
  static final _$deletemesage =
      $grpc.ClientMethod<$0.MessageDto, $0.ResponseDto>(
          '/ChatsRpc/Deletemesage',
          ($0.MessageDto value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $0.ResponseDto.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.ListChatsDto> fetchAllChats($0.RequestDto request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$fetchAllChats, request, options: options);
  }

  $grpc.ResponseFuture<$0.ResponseDto> createChat($0.ChatDto request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createChat, request, options: options);
  }

  $grpc.ResponseFuture<$0.ResponseDto> deleteChat($0.ChatDto request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteChat, request, options: options);
  }

  $grpc.ResponseFuture<$0.ChatDto> fetchChat($0.ChatDto request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$fetchChat, request, options: options);
  }

  $grpc.ResponseFuture<$0.ResponseDto> sendMessage($0.MessageDto request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$sendMessage, request, options: options);
  }

  $grpc.ResponseFuture<$0.ResponseDto> deletemesage($0.MessageDto request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deletemesage, request, options: options);
  }

  $grpc.ResponseStream<$0.MessageDto> listenChat($0.ChatDto request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
        _$listenChat, $async.Stream.fromIterable([request]),
        options: options);
  }
}
...
abstract class ChatsRpcServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.ResponseDto> deletemesage_Pre(
      $grpc.ServiceCall call, $async.Future<$0.MessageDto> request) async {
    return deletemesage(call, await request);
  }

  $async.Stream<$0.MessageDto> listenChat_Pre(
      $grpc.ServiceCall call, $async.Future<$0.ChatDto> request) async* {
  ...
  $async.Future<$0.ResponseDto> deletemesage(
      $grpc.ServiceCall call, $0.MessageDto request);
  $async.Stream<$0.MessageDto> listenChat(
      $grpc.ServiceCall call, $0.ChatDto request);
}
