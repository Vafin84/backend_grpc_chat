...
const ListChatsDto$json = const {
  '1': 'ListChatsDto',
  '2': const [
    const {'1': 'chats', '3': 1, '4': 3, '5': 11, '6': '.ChatDto', '10': 'chats'},
  ],
};

/// Descriptor for `ListChatsDto`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listChatsDtoDescriptor = $convert.base64Decode('CgxMaXN0Q2hhdHNEdG8SHgoFY2hhdHMYASADKAsyCC5DaGF0RHRvUgVjaGF0cw==');
@$core.Deprecated('Use chatDtoDescriptor instead')
const ChatDto$json = const {
  '1': 'ChatDto',
  '2': const [
...
const MessageDto$json = const {
  ...
  '2': const [
    ...
    const {'1': 'author_id', '3': 3, '4': 1, '5': 9, '10': 'authorId'},
    const {'1': 'chat_id', '3': 4, '4': 1, '5': 9, '10': 'chatId'},
  ],
};

/// Descriptor for `MessageDto`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List messageDtoDescriptor = $convert.base64Decode('CgpNZXNzYWdlRHRvEg4KAmlkGAEgASgJUgJpZBISCgRib2R5GAIgASgJUgRib2R5EhsKCWF1dGhvcl9pZBgDIAEoCVIIYXV0aG9ySWQSFwoHY2hhdF9pZBgEIAEoCVIGY2hhdElk');
